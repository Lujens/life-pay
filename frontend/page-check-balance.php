...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($pin, $user->pin)) {
        // Left empty so when the user return to the page it appears to be in its original state.
...
<div class="container">
    <h1></h1>
    <form method="POST" action="/balance-result">
        <label for="account-number">Nom d'utilisateur ou No. de Compte</label>
